...
def Scene(ri):
    ...
    ri.Surface(
        "AOVplastic",
        {
            "color SurfaceColor": [1, 1, 0],
            "color Transparency": [0.5, 0.5, 0.5],
            "float Ka": [0.1],
            "float Kd": [0.5],
            "color Specularcolor": [1, 1, 1],
        },
    ...
    while plank <= 5.0:
        ...
        ri.Surface(
            "AOVplastic",
            {
                "color SurfaceColor": [0.4, 0.4, 0.4],
                "color Transparency": [1, 1, 1],
                "float Ka": [0.1],
                "float Kd": [0.5],
                "color Specularcolor": [1, 1, 1],
...
ri.Display(
    ...
    "rgba",
    {
        "string filter": ["separable-catmull-rom"],
...
ri.Display(
    ...
    "openexr",
    "Oambient",
    {"int[4] quantize": [0, 0, 0, 0], "float dither": [0]},
)
ri.Display(
    "+Oreflect.0001.exr",
    "openexr",
...
Spot2Name = "Spot2"
coneAngle2 = 0.3
ri.Attribute("visibility", {"int diffuse": 1, "int specular": 1, "int transmission": 1})
