...
for frame in range(0,1) :
	...
	ri.Bxdf( 'PxrMarschnerHair', 'corn', { 
	'float specularGainTT' : [.66], 'color specularColorTRT' : [1, 1, 1], 'color specularColorTT' : [1, 1 ,1], 'color diffuseColor' : [.519, .325, .125] , 'int diffuseModelType' : [0]})
