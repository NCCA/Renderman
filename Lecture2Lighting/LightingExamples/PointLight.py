...
def Scene(ri) :
	...
	while (plank <=5.0) :
		...
		ri.Surface("wood",{"Ks":[0.1],"point c0":c0,"point c1":c1,"float grain":random.randint(2,6)})
...
ri.Display("PointLight.exr", "it", "rgba")
...
ri.TransformBegin()
ri.Translate(2,2,4)
ri.LightSource("pointlight", {ri.HANDLEID:"Light2", "point from":[0,0,0] ,"float intensity" :[8]})
ri.TransformEnd()
