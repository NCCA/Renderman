...
def main(filename,shadingrate=10,pixelvar=0.1,
  ...
  exrFile='+MultipleFiles{0}.exr'
  ri.Display(exrFile.format('NormalWS'),'openexr', '__Nworld', exrFormat)
  ri.Display(exrFile.format('PWS'),'openexr', '__Pworld', exrFormat)
  ri.Display(exrFile.format('Depth'),'openexr', '__depth', exrFormat)
