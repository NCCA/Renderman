...
def main(
    ...
    ri.Bxdf("PxrDiffuse", "base", {"color diffuseColor": [0.1, 0.1, 0.1], "string __materialid": ["base"]})
    ...
    ri.Bxdf("PxrDisney", "ball", {"reference color baseColor": ["starBall:Cout"], "string __materialid": ["ball"]})
