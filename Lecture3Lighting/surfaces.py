...
def main(
    ...
    Assets.loadAsset(
        "Oak", "/Applications/Pixar/RenderManProServer-21.4/lib/RenderManAssetLibrary/Materials/Wood/Gritz_Oak.rma"
    )
    Assets.loadAsset(
        "BlueMarble",
        "/Applications/Pixar/RenderManProServer-21.4/lib/RenderManAssetLibrary/Materials/Minerals/Blue_Marble.rma",
    )

    Assets.loadAsset(
        "light",
        "/Applications/Pixar/RenderManProServer-21.4/lib/RenderManAssetLibrary/EnvironmentMaps/Indoor/Pixar_Atrium.rma",
    )
    Assets.loadAsset(
        "luxo",
        "/Applications/Pixar/RenderManProServer-21.4/lib/RenderManAssetLibrary/EnvironmentMaps/Outdoor/LuxoJr.rma",
    )
    Assets.loadAsset(
        "griff",
        "/Applications/Pixar/RenderManProServer-21.4/lib/RenderManAssetLibrary/EnvironmentMaps/Outdoor/GriffithObservatory.rma",
    )
