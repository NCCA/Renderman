...
def main(
    ...
    ri.Bxdf("PxrSurface", "plastic", {"reference color diffuseColor": ["band:Cout"], "int diffuseDoubleSided": [1]})
    drawScene(ri, 0)
    ri.Pattern(
        "band",
        "band",
    ...
    ri.Pattern("band", "band", {"string direction": ["vertical"], "color C1": [0, 0, 1], "color C2": [0, 1, 0]})
    ri.Bxdf("PxrSurface", "plastic", {"reference color diffuseColor": ["band:Cout"], "int diffuseDoubleSided": [1]})
    drawScene(ri, 2)
