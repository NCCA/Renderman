...
def main(
    ...
    ri.Pattern("diskrepeat", "diskrepeat", {})

    ri.Bxdf(
        "PxrSurface",
        "plastic",
        {"reference color diffuseColor": ["diskrepeat:resultRGB"], "int diffuseDoubleSided": [1]},
    )
    drawScene(ri, 0)
    ri.Pattern(
        "diskrepeat",
        "diskrepeat",
        {
            ...
            "float repeatV": [5],
            "float radius": [0.2],
            "color diskColour": [1, 1, 1],
            "color baseColour": [0, 0, 1],
        },
    )
    ...
    ri.Bxdf(
        ...
        "bxdf",
        {
            "reference color baseColor": ["diskrepeat:resultRGB"],
        },
    )
    drawScene(ri, 1)
    ...
    expression = """$r=($u - floor($u)); # set r to be the clamped $u texture co-ordinate 
              ...
              """
    ri.Pattern("PxrSeExpr", "uvshader", {"string expression": [expression]})
...
if __name__ == "__main__":
    ...
    checkAndCompileShader("diskrepeat")
