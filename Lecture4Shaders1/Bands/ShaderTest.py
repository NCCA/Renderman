...
def Scene(ri) :
	...
	while (plank <=5.0) :
		ri.TransformBegin()
		ri.Surface(  "Band" ,{ "color C1": [1.000 ,0.000, 0.000],  "color C2": [0.000 ,0.000, 1.000], "float begin": [0.300],"float end": [0.600],"float Ka": [1.000],"float Kd": [0.500],"float Ks": [0.500],"float roughness": [0.100], "color specularcolor": [1.000 ,1.000, 1.000], "float Orient": [Orient], })
	...
	ri.Color([0.27,0.04,0.36])
	ri.Surface(  "Band" ,{ "color C1": [1.000 ,0.000, 0.000],  "color C2": [0.000 ,0.000, 1.000], "float begin": [0.300],"float end": [0.600],"float Ka": [1.000],"float Kd": [0.500],"float Ks": [0.500],"float roughness": [0.100], "color specularcolor": [1.000 ,1.000, 1.000], "float Orient": [1], })
	ri.Geometry("teapot")
	ri.AttributeEnd()
	ri.TransformEnd()
