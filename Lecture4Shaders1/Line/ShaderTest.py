...
def Scene(ri) :
	...
	ri.Color([0.27,0.04,0.36])
	ri.Surface(  "Lines" ,{ "color LineColor": [1.000 ,0.000, 0.000],  "color MixColor": [1.000 ,1.000, 1.000], "float fuzz": [0.030],"float LineSize": [0.300],"float Ka": [1.000],"float Kd": [0.500],"float Ks": [0.500],"float roughness": [0.100], "color specularcolor": [1.000 ,1.000, 1.000], "float Orient": [1.000],"float offset": [0.500], })
	ri.Geometry("teapot")
	ri.AttributeEnd()
	ri.TransformEnd()
