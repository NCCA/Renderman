...
def Scene(ri) :
	...
	while (plank <=5.0) :
		ri.TransformBegin()
		ri.Surface(  "RampShader" ,{ "color BlendColor": [1.000 ,0.000, 0.161], "float orientation": [Orient],"float Ka": [1.000],"float Kd": [0.500],"float Ks": [0.500],"float roughness": [0.100], "color specularcolor": [1.000 ,1.000, 1.000],  })
	...
	ri.Color([0.27,0.04,0.36])
	ri.Surface(  "RampShader" ,{ "color BlendColor": [1.000 ,0.000, 0.161], "float orientation": [1],"float Ka": [1.000],"float Kd": [1],"float Ks": [0.500],"float roughness": [0.100], "color specularcolor": [1.000 ,1.000, 1.000],  })
	ri.Geometry("teapot")
	ri.AttributeEnd()
	ri.TransformEnd()
