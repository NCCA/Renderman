...
def Scene(ri) :
	...
	plank=-5.0
	ri.Color([1,1,1])
	ri.Surface(  "CellNoise" ,{"float Ka": [1.000],"float Kd": [0.500],"float Ks": [0.500],"float roughness": [0.100], "color specularcolor": [1.000 ,1.000, 1.000], "float RepeatS": [5.000],"float RepeatT": [5.000], })
