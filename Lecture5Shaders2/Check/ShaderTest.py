...
def Scene(ri) :
	...
	ri.Color([1,1,1])
	ri.Surface(  "Check" ,{"float Ka": [0.900],"float Kd": [0.500],"float Ks": [0.500],"float roughness": [0.100], "color specularcolor": [1.000 ,1.000, 1.000],  "color CheckColour": [1.000 ,0.031, 0.063], "float RepeatS": [4.000],"float RepeatT": [8.000], })
	...
	ri.Color([1,1,1])
	ri.Surface(  "Check" ,{"float Ka": [0.900],"float Kd": [0.500],"float Ks": [0.500],"float roughness": [0.100], "color specularcolor": [1.000 ,1.000, 1.000],  "color CheckColour": [0 ,0, 0], "float RepeatS": [8.000],"float RepeatT": [8.000], })
	ri.Geometry("teapot")
	ri.AttributeEnd()
	ri.TransformEnd()
