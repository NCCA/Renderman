...
def Scene(ri) :
	...
	plank=-5.0
	ri.Color([1,1,1])
	ri.Surface(  "EnvMap" ,{"float Ka": [1.000],"float Kd": [0.500],"float Ks": [0.400],"float Kr": [0.100],"float roughness": [0.030], "color specular": [1.000 ,1.000, 1.000], "string MapName" : "map.tx", "float xroughness": [0.320],"float yroughness": [0.200], })
	...
	ri.Surface(  "EnvMap" ,{"float Ka": [1.000],"float Kd": [0.500],"float Ks": [0.700],"float Kr": [0.200],"float roughness": [0.030], "color specular": [0.4,0.4,0.4], "string MapName" : "map.tx", "float xroughness": [0.20],"float yroughness": [0.300], })
	ri.Geometry("teapot")
	ri.TransformEnd()
