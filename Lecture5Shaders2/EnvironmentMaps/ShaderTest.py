...
def Scene(ri):
    ...
    ri.Surface(
        "EnvMap",
        {
            ...
            "color specular": [1.000, 1.000, 1.000],
            "string MapName": "map.tx",
            "float xroughness": [0.320],
            "float yroughness": [0.200],
        },
    )
    ...
    ri.Surface(
        "EnvMap",
        {
            ...
            "float Kr": [0.200],
            "float roughness": [0.030],
            "color specular": [0.4, 0.4, 0.4],
            "string MapName": "map.tx",
            "float xroughness": [0.20],
            "float yroughness": [0.300],
        },
    )
    ri.Geometry("teapot")
    ri.TransformEnd()
