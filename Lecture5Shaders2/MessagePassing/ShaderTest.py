...
def Scene(ri) :
	...
	ri.Color([1,1,1])
	ri.Displacement(  "SurfaceBump" ,{"float Km": [0.100],"float freq": [4.000],"float hump": [0.000], })
	ri.Surface(  "SurfaceShader" ,{"float Kd": [0.500],"float snow_ht": [0.000], "color snow_color": [1.000 ,1.000, 1.000],  "color ground_color": [0.466 ,0.388, 0.309],  })
	...
	ri.Color([1,1,0])
	ri.Displacement(  "SurfaceBump" ,{"float Km": [0.100],"float freq": [18.000],"float hump": [0.000], })
	ri.Surface(  "SurfaceShader" ,{"float Kd": [0.800],"float snow_ht": [0.000], "color snow_color": [0.000 ,0.000, 0.200],  "color ground_color": [0 ,1, 1],  })
