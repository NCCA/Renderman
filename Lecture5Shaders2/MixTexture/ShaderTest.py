...
def Scene(ri) :
	...
	ri.Translate(0,0,2)
	ri.Rotate(90,1,0,0)
	ri.Surface(  "MixTexture" ,{"float Ka": [1.000],"float Kd": [0.500],"float Ks": [0.500],"float roughness": [0.100], "color specularcolor": [1.000 ,1.000, 1.000], "string tex1" : "tile.tx", "string tex2" : "window1.tx", "string tex3" : "window2.tx", "float RepeatS": [10.000],"float RepeatT": [10.000],"float range1": [0.700],"float range2": [0.90], })
