...
def Scene(ri) :
	...
	ri.Color([1,1,1])
	ri.Surface(  "ModulateTexture" ,{"float Ka": [1.000],"float Kd": [0.500],"float Ks": [0.500],"float roughness": [0.100], "color specularcolor": [1.000 ,1.000, 1.000], "string TextureName" : "brick.tx", "float RepeatS": [10.000],"float RepeatT": [10.000], })
