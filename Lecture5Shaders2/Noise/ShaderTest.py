...
def Scene(ri) :
	...
	plank=-5.0
	ri.Color([1,1,1])
	ri.Surface(  "Noise" ,{"float Ka": [1.000],"float roughness": [0.010],"float RepeatS": [1.000],"float RepeatT": [1.000],"float Frequency": [4.000], })
	...
	ri.Color([1,1,1])
	ri.Surface(  "Noise" ,{"float Ka": [1.000],"float roughness": [0.010],"float RepeatS": [10.000],"float RepeatT": [10.000],"float Frequency": [14.000], })
	ri.Geometry("teapot")
	ri.AttributeEnd()
	ri.TransformEnd()
