...
def Scene(ri) :
	...
	plank=-5.0
	ri.Color([1,1,1])
	ri.Surface(  "RandomSpots" ,{"float Ka": [1.000],"float Kd": [0.500],"float Ks": [0.500],"float roughness": [0.100], "color specularcolor": [1.000 ,1.000, 1.000], "float RepeatS": [12.000],"float RepeatT": [12.000],"float fuzz": [0.030], })
	...
	ri.Color([1,1,1])
	ri.Surface(  "RandomSpots" ,{"float Ka": [1.000],"float Kd": [0.500],"float Ks": [0.500],"float roughness": [0.100], "color specularcolor": [1.000 ,1.000, 1.000], "float RepeatS": [8.000],"float RepeatT": [8.000],"float fuzz": [0.0030], })
	ri.Geometry("teapot")
	ri.AttributeEnd()
	ri.TransformEnd()
