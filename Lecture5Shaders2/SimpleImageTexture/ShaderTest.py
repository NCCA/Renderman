...
def Scene(ri) :
	...
	plank=-5.0
	ri.Color([1,1,1])
	ri.Surface(  "SimpleTexture" ,{"float Ka": [1.000],"float Kd": [0.500],"float Ks": [0.500],"float roughness": [0.100], "color specularcolor": [1.000 ,1.000, 1.000], "string TextureName" : "renderman.tx", "float RepeatS": [4.000],"float RepeatT": [4.000], })
	...
	ri.Surface(  "SimpleTexture" ,{"float Ka": [1.000],"float Kd": [0.800],"float Ks": [0.500],"float roughness": [0.100], "color specularcolor": [1.000 ,1.000, 1.000], "string TextureName" : "heli1.tx", "float RepeatS": [1.000],"float RepeatT": [1.000], })
	obj.Polygon(ri,5)
	ri.TransformEnd()
