/* rmannotes.sl : renamed to rmannotes.h for RMR -- tal
 * 
...
/*#define pulse ... renamed this to smoothPulse to not conflict with arman's pulse function */
#define smoothPulse(a,b,fuzz,x) (smoothstep((a)-(fuzz),(a),(x)) - \
