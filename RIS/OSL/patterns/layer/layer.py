...
ri.AttributeEnd()
ri.Pattern("layer",shaderName, {"color baseColour"  : [1.0 ,1.0,1.0],
...
ri.Bxdf( "PxrDisney","bxdf", {"reference color baseColor" : ["%s:Cout"%shaderName]})
drawTeapot(ri,ry=-45)
ri.Pattern("layer",shaderName, {"float repeatU" : [8],  
                                "float repeatV" : [8],  
                                "color baseColour"  : [1.0 ,1.0,1.0],
                                "color lineColour1" : [0.0 , 0.0, 1.0],
                                "color lineColour2" : [0.0 , 0.4, 0.4],
                                "float fuzz" : [0.2], 
                                "float thicknessU" : [0.2],
                                "float thicknessV" : [0.2] })
# third teapot
ri.Bxdf( "PxrDisney","bxdf", {"reference color baseColor" : ["%s:Cout"%shaderName] })
drawTeapot(ri,x=1,ry=-45)
# floor
