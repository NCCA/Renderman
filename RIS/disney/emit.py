...
# first teapot
ri.AttributeBegin()
ri.Bxdf("PxrDisney", "bxdf", {"color baseColor": [0.5, 0.0, 0.0], "color emitColor": [1.0, 0.0, 0.0]})
drawTeapot(ri, x=-1, ry=-45)
ri.AttributeEnd()

# second teapot
ri.Bxdf("PxrDisney", "bxdf", {"color baseColor": [0.5, 0.0, 0.0], "color emitColor": [0.5, 0.0, 0.0]})
drawTeapot(ri, ry=-45)

# third teapot
ri.Bxdf("PxrDisney", "bxdf", {"color baseColor": [1.0, 0.0, 0.0], "color emitColor": [0.0, 0.0, 0.0]})
drawTeapot(ri, x=1, ry=-45)
# floor
ri.TransformBegin()
