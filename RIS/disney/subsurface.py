...
ri.Bxdf(
    "PxrDisney",
    "bxdf",
    {"color baseColor": [1.0, 0.0, 0.0], "float subsurface": [0.667], "color subsurfaceColor": [1.000, 0.714, 0.757]},
)
...
ri.Bxdf(
    "PxrDisney",
    "bxdf",
    {"color baseColor": [1.0, 0.0, 0.0], "float subsurface": [0.333], "color subsurfaceColor": [1.000, 0.714, 0.757]},
)
drawTeapot(ri, ry=-45)
...
ri.Bxdf(
    "PxrDisney",
    "bxdf",
    {"color baseColor": [1.0, 0.0, 0.0], "float subsurface": [0], "color subsurfaceColor": [1.000, 0.714, 0.757]},
)
drawTeapot(ri, x=1, ry=-45)
# floor
ri.TransformBegin()
