...
cam = Camera(Vec4(0, 1, -4), Vec4(0, 0, 0), Vec4(0, 1, 0))
cam.place(ri)
...
# first teapot
ri.Bxdf("PxrDisney", "bxdf", {"color baseColor": [0.8, 0.2, 0.2], "float metallic": [0]})
drawTeapot(ri, x=-1)

# troll
ri.TransformBegin()
ri.Bxdf("PxrDisney", "bxdf", {"color baseColor": [0.8, 0.2, 0.2], "float metallic": [0.6]})
...
ri.TransformEnd()
# third teapot
ri.Bxdf("PxrDisney", "bxdf", {"color baseColor": [0.8, 0.2, 0.2], "float roughness": [0.5], "float metallic": [1.0]})
drawTeapot(ri, x=1)
# floor
ri.TransformBegin()
ri.Bxdf("PxrDisney", "bxdf", {"color baseColor": [1, 1, 1], "float roughness": [0.2], "float metallic": [0.8]})
s = 2.0
