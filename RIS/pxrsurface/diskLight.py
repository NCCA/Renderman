...
def main(filename,shadingrate=10,pixelvar=0.1,
  ...
  ri.Begin(filename)
  ri.Option('searchpath', {'string archive':'../../Lecture3Lighting/assets/:@'})
  ...
  ri.Bxdf('PxrSurface','surface',
  {
	'float diffuseGain' : [0.0], 
	'float refractionGain' : [0.9], 
	'float reflectionGain' : [0.8], 
	'color refractionColor' : [0.95,0.95,0.95], 
	'float glassRoughness' : [0.0], 
  'float glassIor' : [1.54], 
	'int thinGlass' : [1] 
  })
  ...
  ri.Bxdf('PxrSurface','surface',
  {
	...
	'float refractionGain' : [0.9], 
	'float reflectionGain' : [0.8], 
	'color refractionColor' : [0.95,0.05,0.05], 
	'float glassRoughness' : [0.0], 
  'float glassIor' : [1.54], 
	'int thinGlass' : [0] 
  })
  ...
  ri.Bxdf('PxrSurface','surface',
  {
	...
	'float refractionGain' : [0.9], 
	'float reflectionGain' : [0.8], 
	'color refractionColor' : [0.05,0.95,0.05], 
	'float glassRoughness' : [0.0], 
  'float glassIor' : [1.54], 
	'int thinGlass' : [1] 
  })
