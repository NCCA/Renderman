...
ri.AreaLightSource(
    "PxrStdEnvMapLight",
    {ri.HANDLEID: "areaLight", "float exposure": [1.0], "string rman__EnvMap": ["Exterior1_Color.tx"]},
)
...
ri.Pattern(
    "PxrOSL",
    "noiseShader",
    {"string shader": "noise", "color Cin": [1.0, 0.2, 0.0], "float scaleU": [20], "float scaleV": [30]},
)
...
ri.Procedural2(
    ri.Proc2DelayedReadArchive,
    ri.SimpleBound,
    {"string filename": ["shaderBall.zip!shaderBall.rib"], "float[6] __bound": [-2, 2, 0, 2, -2, 2]},
)
ri.Procedural2(
    ri.Proc2DelayedReadArchive,
    ri.SimpleBound,
    {"string filename": ["shaderBall.zip!cones.rib"], "float[6] __bound": [-2, 2, 0, 2, -2, 2]},
)
ri.AttributeEnd()
# BAND
ri.AttributeBegin()
ri.Bxdf(
    "PxrDisney",
    "bxdf",
    {"color baseColor": [0.8, 0.8, 0.8], "float metallic": [0.2], "float roughness": [0], "float specular": [0.1]},
)

ri.Procedural2(
    ri.Proc2DelayedReadArchive,
    ri.SimpleBound,
    {"string filename": ["shaderBall.zip!band.rib"], "float[6] __bound": [-2, 2, 0, 2, -2, 2]},
)
...
"""
# glowing red!
ri.Bxdf("PxrDisney", "bxdf", {"color baseColor": [0.9, 0.0, 0.0], "color emitColor": [1.0, 0.0, 0.0]})

ri.Procedural2(
    ri.Proc2DelayedReadArchive,
    ri.SimpleBound,
    {"string filename": ["shaderBall.zip!innerBall.rib"], "float[6] __bound": [-2, 2, 0, 2, -2, 2]},
)
...
ri.Procedural2(
    ri.Proc2DelayedReadArchive,
    ri.SimpleBound,
    {"string filename": ["shaderBall.zip!chromeBall.rib"], "float[6] __bound": [-2, 2, 0, 2, -2, 2]},
)
...
ri.Procedural2(
    ri.Proc2DelayedReadArchive,
    ri.SimpleBound,
    {"string filename": ["shaderBall.zip!colChecker.rib"], "float[6] __bound": [-2, 2, 0, 2, -2, 2]},
)
ri.AttributeEnd()
...
ri.Bxdf("PxrLMPlastic", "bxdf", {"color diffuseColor": [0.8, 0.8, 0.8]})

ri.Procedural2(
    ri.Proc2DelayedReadArchive,
    ri.SimpleBound,
    {"string filename": ["shaderBall.zip!lambertBall.rib"], "float[6] __bound": [-2, 2, 0, 2, -2, 2]},
)
...
ri.Procedural2(
    ri.Proc2DelayedReadArchive,
    ri.SimpleBound,
    {"string filename": ["shaderBall.zip!signature.rib"], "float[6] __bound": [-2, 2, 0, 2, -2, 2]},
)
...
ri.Pattern(
    ...
    "checkShader",
    {
        "string shader": "simplecheck",
        "float repeatCount": [80],
...
ri.Procedural2(
    ri.Proc2DelayedReadArchive,
    ri.SimpleBound,
    {"string filename": ["shaderBall.zip!floor.rib"], "float[6] __bound": [-2, 2, 0, 2, -2, 2]},
)
